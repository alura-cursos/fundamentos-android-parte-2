...
O projeto é capaz de cadastrar, editar e remover contatos com nome, telefone e e-mail e faz a listagem dos contatos apresentando apenas o nome: 
...
- `ScrollView`: exibição de todas as informações que ultrapassam o tamanho da tela;
